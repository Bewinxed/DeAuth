<script lang="ts">
	...
	import type { AccessControlType, Prisma } from '@prisma/client';
	import { get_svetch } from 'src/lib/context.js';
	import { provider_icons } from 'src/lib/utils/ui_helpers.js';
...
<header
	...
	class="flex place-content-start place-items-center justify-between gap-2 border-b p-4"
>
	<div class="flex place-content-center place-items-center gap-2">
		<PrettyIcon icon="carbon:security"></PrettyIcon>
		<h1 class="font-display text-xl font-bold capitalize">
